...
super_rare_pokemon = ['gloom', 'vulpix', 'ninetales', 'ditto', 'articuno', 'zapdos', 'moltres', 'mewtwo', 'venosaur', 'charizard', 'blastoise', 'clefable', 'tauros', 'omastar', 'dragonite', 'aerodactyl', 'gyarados', 'lapras', 'vaporeon', 'jolteon', 'flareon', 'dragonair', 'kabutops', 'raichu', 'growlithe', 'arcanine', 'ponyta', 'electabuzz', 'rapidash', 'snorlax', 'mr mime', 'machamp']
